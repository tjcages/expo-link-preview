      ...
      {data.includes && data.includes.users.length > 0 && (
        <View style={styles.contentHeader}>
          <Image
            ...
            source={{ uri: data.includes.users[0].profile_image_url }}
          />
          <View style={styles.userInfo}>
            <Copy style={styles.twitterName}>{data.includes.users[0].name}</Copy>
            <Text>@{data.includes.users[0].username}</Text>
          </View>
        </View>
      )}
