...
import TwitterLogo_White from "../../assets/icons/twitter_logo_blue.svg";
    ...
    <Container style={styles.container}>
      {data.includes && data.includes.users.length > 0 && (
        <Container style={styles.logoContainer}>
          ...
          {
            theme === "dark" ? <TwitterLogo_White style={{ width: 24, height: 24 }} /> : <TwitterLogo_Blue style={{ width: 24, height: 24 }} />
          }
        </Container>
      )}
