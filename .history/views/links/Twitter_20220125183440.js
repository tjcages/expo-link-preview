...
import { Container, Title, Copy, Text, useThemeColor } from "../../components/Themed";
    ...
    <Container style={styles.container}>
      {data.includes && data.includes.users.length > 0 && (
        <Container style={styles.logoContainer}>
          ...
          {props.theme === "dark" || "system" ? (
            <TwitterLogo_White style={{ width: 24, height: 24 }} color={secondary} />
          ) : (
