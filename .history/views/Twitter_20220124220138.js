  ...
  const getData = async (twitterURL) => {
    ...
    try {
      const response = await fetch(
        "https://api.twitter.com/2/tweets/1485491595139231744?user.fields=profile_image_url,url&media.fields=duration_ms,height,preview_image_url,type,url,alt_text",
        {
          method: "GET",
          headers: {
            Authorization:
