  ...
  render() {
    return (
      <View style={styles.container}>
        <Title lightColor={Colors.dark.primary} darkColor={Colors.light.primary} style={styles.title}>Welcome to my lil app</Title>
        <Text lightColor={Colors.dark.secondary} darkColor={Colors.light.secondary}>
