...
const Link = (props) => {
  ...
  const renderLink = () => {
    const source = {
      html: `<blockquote class="twitter-tweet" data-theme="dark"><p lang="en" dir="ltr">Build automations that complete Figma tasks for you with just one click.<br><br>Try it out for free: <a href="https://t.co/9VJQFF58Yl">https://t.co/9VJQFF58Yl</a> <a href="https://t.co/XlF7W5GKzz">pic.twitter.com/XlF7W5GKzz</a></p>&mdash; Product Hunt 😸 (@ProductHunt) <a href="https://twitter.com/ProductHunt/status/1485629473206718466?ref_src=twsrc%5Etfw">January 24, 2022</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>`
    }
    ...
    //   source={source}
    // />
    <TouchableOpacity id="Bbbm0WmgVLa" style={{ width: "100%", height: 100, backgroundColor: "red" }} />
      // <WebView
      //   ref={webviewRef}
