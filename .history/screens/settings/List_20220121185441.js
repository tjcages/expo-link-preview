...
import { useThemeColor, Copy, Text, View } from "../../components/Themed";
...
const Item = ({ item }) => {
  ...
  const secondary = useThemeColor(
    { lightColor: Colors.light.secondary, darkColor: Colors.dark.secondary },
    "secondary"
  );
  const container = useThemeColor(
    { lightColor: Colors.light.background, darkColor: Colors.dark.highlight },
    "highlight"
  );
