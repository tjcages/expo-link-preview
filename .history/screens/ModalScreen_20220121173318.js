...
import { TouchableOpacity, Platform, StyleSheet, SectionList, Switch } from "react-native";
    ...
    <Container style={[styles.container, { backgroundColor: background }]}>
      ...
      <View style={styles.content}>
        <SectionList
          ...
          renderItem={({ item }) => <Item background={container} item={item} />}
...
const Item = ({ item, background }) => {
  ...
  return (
    <TouchableOpacity style={[styles.item, { backgroundColor: background}]}>
      <View
        style={{
