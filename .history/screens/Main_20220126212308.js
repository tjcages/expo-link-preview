...
import { View, Container, Title, Copy } from "../components/Themed";
  ...
  const renderItem = ({ item }) => (
    ...
    >
      <Container style={styles.item}>
        ...
        <Text style={styles.subtitle}>Carter posted 3 min ago</Text>
      </Container>
...
const styles = StyleSheet.create({
  ...
  title: { marginLeft: 8, marginTop: 12, textAlign: "center", fontSize: 20 },
  subtitle: { marginLeft: 8, marginTop: 12, textAlign: "center" },
});
