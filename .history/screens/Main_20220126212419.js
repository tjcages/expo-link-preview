  ...
  const renderItem = ({ item }) => (
    ...
    >
      <Container style={styles.item}>
        ...
        <Text style={styles.subtitle}>Carter posted</Text>
      </Container>
...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, marginLeft: 8, marginTop: 12, textAlign: "center", fontSize: 20 },
  subtitle: { marginLeft: 8, marginTop: 12, textAlign: "center", fontWeight: "bold"},
});
