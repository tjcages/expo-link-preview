...
export function TextField(props) {
  const { style, lightColor, darkColor, addContainer, icon, ...otherProps } = props;
  const color = useThemeColor(
    { light: lightColor, dark: darkColor },
    "primary"
  );
  ...
  return (
    <DefaultView style={{ flex: 1 }}>
      <TextInput
        style={[{ color }, addContainer && { backgroundColor }, fieldStyles.textField, style]}
...
export function SendButton(props) {
  ...
  return (
    <DefaultView style={buttonStyles.sendButtonContainer}>
      <DefaultButton
        {...otherProps}
        onPress={onPress}
        disabled={disabled}
